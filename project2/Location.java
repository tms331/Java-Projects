...
public enum Location {
    EDISON      ("EDISON",      8837, "MIDDLESEX"),
    PISCATAWAY  ("PISCATAWAY",  8854, "MIDDLESEX"),
    BRIDGEWATER ("BRIDGEWATER", 8807, "SOMERSET"),
    FRANKLIN    ("FRANKLIN",    8873, "SOMERSET"),
    SOMERVILLE  ("SOMERVILLE",  8876, "SOMERSET");
     ...
     */
    Location(String town, int zip, String county){
        this.town = town;
        this.zip = zip;
        this.county = county;
    }
