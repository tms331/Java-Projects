...
public class ChicagoPizzaActivity extends Activity implements Customizable{
    ...
    private final String[] types = new String[]{"Deluxe", "BBQ Chicken", "Meatzza", "Build Your Own"};
    ...
    private void setBackButton(){
        backButton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(ChicagoPizzaActivity.this, PizzaManagerActivity.class);
    ...
    private void setPizzaImage(){
        //int selected = pizzaButtons.getCheckedRadioButtonId();
        String selected = selectedType;

        switch (selected){
            case "Deluxe":
                pizzaImage.setImageResource(R.drawable.deluxe_chicago);
                break;
            case "BBQ Chicken":
                pizzaImage.setImageResource(R.drawable.bbq_chicago);
                break;
            case "Meatzza":
                pizzaImage.setImageResource(R.drawable.meatzza_chicago);
                break;
            case "Build Your Own":
                pizzaImage.setImageResource(R.drawable.build_your_own_chicago);
                break;
        }
    }
    ...
    private Pizza getCustomizedPizza(){
        ...
        switch(selectedType){
            case "Deluxe": {returnPizza = ChicagoFactory.createDeluxe(); break;}
            case "Meatzza": {returnPizza = ChicagoFactory.createMeatzza(); break;}
            case "BBQ Chicken": {returnPizza = ChicagoFactory.createBBQChicken(); break;}
            case "Build Your Own": {returnPizza = ChicagoFactory.createBuildYourOwn(); break;}
