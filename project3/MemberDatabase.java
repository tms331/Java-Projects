...
public class MemberDatabase {
     ...
     * @return String, the member database
     */
    public String print(){
     ...
     * @return String the member database sorted by county
     */
     ...
     * @return String, the member database sorted by expiration date
     */
     ...
     * @return String the member database sorted by last name, first name
     */
     ...
     * @return the member database with fees
     */
    ...
    /**
     * Method to load in legacy members from file.
     ...
     */
    public String memberLoop(File file) throws FileNotFoundException {
        ...
        while (fileScanner.hasNextLine()) {
            ...
            if (inputArray.length == 5) {
                ...
                add(new Member(fname, lname, dob, expire, loc));
            }
        }
        fileScanner.close();
        if(size == 0){
            return "No Members added! Check file format!";
        }
        return this.toString();
    }
}