...
public class Member implements Comparable<Member>{
    ...
    public Member(String fname, String lname, Date dob){
        this(fname, lname, dob, Date.get3Months(), Location.PISCATAWAY);
    }
     ...
     * @param lname, users last name.
     * @param dob, users date of birth.
     * @param loc, location the user is apart of
     */
    public Member(String fname, String lname, Date dob, Location loc){
        this(fname, lname, dob, Date.get3Months(), loc);
    }
