...
public class Date implements Comparable<Date>{
    ...
    /**
     * Date constructor to construct today's date given the integer values
     * of the date given from ##/##/##
     * @param month the month to be stored
     * @param day the day to be stored
     * @param year, the year to be stored
     */
    public Date(int month, int day, int year){
        this.month = month-1; // -1 because Date stores month 0-11 but ##/##/## format use 1-12
        this.day = day;
        this.year = year;
    }
