...
public class NyPizzaController implements Initializable {
    ...
    private void setImage(String pizzaName){
        try{
            ...
            switch(pizzaName) {
                case "Deluxe" -> {
                    image = new Image(PizzaManagerMain.class.getResource("deluxe_NY.jpg").openStream());
                }
                case "Meatzza" -> {
                    image = new Image(PizzaManagerMain.class.getResource("meatzza_NY.jpg").openStream());
                }
                case "BBQ Chicken" -> {
                    image = new Image(PizzaManagerMain.class.getResource("BBQ_NY.jpg").openStream());
                }
                default -> {
                    image = new Image(PizzaManagerMain.class.getResource("buildYourOwn_NY.jpg").openStream());
                }
            }
    ...
    private Pizza getCustomizedPizza(String pizzaName){
        ...
        switch(pizzaName){
            case "Deluxe" -> {returnPizza = NYFactory.createDeluxe();}
            case "Meatzza" -> {returnPizza = NYFactory.createMeatzza();}
            case "BBQ Chicken" -> {returnPizza = NYFactory.createBBQChicken();}
            case "Build Your Own" -> {returnPizza = NYFactory.createBuildYourOwn();}
